...
define('CLOUDADDONS_WEBSITE_URL', 'https://addon.dismall.com');
define('CLOUDADDONS_DOWNLOAD_URL', 'https://addon.dismall.com/index.php');
define('CLOUDADDONS_DOWNLOAD_IP', '');
define('CLOUDADDONS_CHECK_URL', 'https://addon1.dismall.com');
...
function cloudaddons_url($extra) {
	...
	$data = 'siteuniqueid='.rawurlencode($uniqueid).'&siteurl='.rawurlencode($_G['siteurl']).'&sitever='.DISCUZ_VERSION.'/'.DISCUZ_RELEASE.'&sitecharset='.CHARSET.'&mysiteid='.$_G['setting']['my_siteid'].'&addonversion=1';
