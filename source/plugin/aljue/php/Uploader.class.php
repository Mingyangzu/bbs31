...
class Uploader
{
    ...
    public function __construct($fileField, $config, $type = "upload")
    {
        ...
        $this->stateMap['ERROR_TYPE_NOT_ALLOWED'] = 1212;
    }
        ...
        if (!(move_uploaded_file($file["tmp_name"], $this->filePath) && file_exists($this->filePath))) { //移动失败
            ...
            if(file_exists($this->filePath)){
                ...
                if($_G['cache']['plugin']['aljoss']['Access_Key']){
                    ...
                    $this->fullName = $this->oss($this->filePath, 'aljbd/goods');
                }
            }
    ...
    private function getFilePath()
    {
        ...
        $rootPath = str_replace('source/plugin/aljue', '', $rootPath);
    ...
    public function oss($pic, $dir = 'test'){
        define('DISABLEXSSCHECK', true);
        require_once './../../../../source/class/class_core.php';
        $discuz = C::app();
        $cachelist = array('plugin');
        ...
        $discuz->init();
        global $_G;
        require_once './../../../../source/plugin/aljue/php/class_oss.php';
        $oss = new Oss();
        $rand = rand(100, 999);
