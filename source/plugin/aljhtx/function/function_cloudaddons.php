...
$addon = $addonsource ?
	...
	array(
		'website_url' => 'http://g.com/AppCenter/',
		'download_url' => 'http://g.com/AppCenter/index.php',
		'download_ip' => '',
		'check_url' => 'http://g.com/AppCenter/md5/',
		'check_ip' => '',
	);
...
function cloudaddons_getuniqueid() {
	global $_G;
	if(CLOUDADDONS_WEBSITE_URL == 'http://addon.dismall.com') {
...
function cloudaddons_url($extra) {
	...
	$param .= '&md5hash='.substr(md5($data.TIMESTAMP), 8, 8).'&time='.TIMESTAMP;
