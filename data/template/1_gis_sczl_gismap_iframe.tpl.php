...
<div style="display: flex;flex-direction: row;">
                                            <?php if($float == true ) { ?>
<div style="width:20px;height:20px;margin:8px 5px;">
                                            <?php } else { ?>
                                                <div style="width:20px;height:20px;margin:0px 5px;">
                                            <?php } ?>

                                                    <img src="<?php echo $_G['gis']['dirstyle'];?>images/map.png" class="imgs" /></div>
<div>地图标注</div>
</div>
                                        <?php if($float == true ) { ?>
<div style="width:20px;height:20px;margin:0px 10px 0;" id="gbzg">
                                            <?php } else { ?>
                                                <div style="width:20px;height:20px;margin:-26px 10px 0;" id="gbzg">
                                            <?php } ?>
